...
# MAGIC 
# MAGIC Go back to the [DLT ingestion pipeline notebook]($./01-Wind-Turbine-DLT-pipeline) or open the [DBSQL Predictive Maintenance dashboard]([DBSQL Dashboard](https://e2-demo-field-eng.cloud.databricks.com/sql/dashboards/90b2c9c7-e5c7-46d8-b7fe-5b98ed84d5d1-turbine-demo-predictions?o=1444828305810485)
# MAGIC <br/><br/>
