...
reset_webhooks(model_name = "demos_customer_churn")

#Once we have the id of the job running the tests, we add the hook:
create_job_webhook(model_name = "demos_customer_churn", job_id = job_id)
...
create_notification_webhook(model_name = "demos_customer_churn", slack_url = "https://hooks.slack.com/services/T00000000/B00000000/XXXXXXXXXXXXXXXXXXXXXXXX")
...
# List
list_webhooks("demos_customer_churn")
