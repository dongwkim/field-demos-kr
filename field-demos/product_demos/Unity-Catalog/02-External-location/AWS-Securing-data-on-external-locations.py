...
#Please specify the URL of the bucket you want to use for your external location:
#  - E2 FE demo: "s3a://databricks-e2demofieldengwest"
#  - CSE2:       "s3a://databricks-field-demos-cs-uc-external-location"
...
# MAGIC 
# MAGIC <img src="https://github.com/QuentinAmbard/databricks-demo/raw/main/product_demos/uc/external/uc-external-location-2.png" style="float:right; margin-left:10px" width="700px"/>
# MAGIC 
...
# MAGIC 
# MAGIC <img src="https://github.com/QuentinAmbard/databricks-demo/raw/main/product_demos/uc/external/uc-external-location-3.png" style="float:right; margin-left:10px" width="700px"/>
# MAGIC 
...
# MAGIC %sql
# MAGIC -- CSE2 URL: s3a://databricks-field-demos-cs-uc-external-location/external_location/
# MAGIC -- E2FE URL: s3a://databricks-e2demofieldengwest/external_location/
