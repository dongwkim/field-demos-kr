...
-- Note: you need to be account ADMIN to create the shares. They have been created for you!
...
--UNCOMMENT_FOR_DEMO ALTER SHARE americanairlines  ADD TABLE airlinedata.lookupcodes ;
--UNCOMMENT_FOR_DEMO ALTER SHARE southwestairlines ADD TABLE airlinedata.lookupcodes;

-- COMMAND ----------

-- DBTITLE 1,Get In-House Unique Carrier Codes to Filter Specifically to Only the Relevant Airlines
SELECT * FROM airlinedata.lookupcodes WHERE Description = "Southwest Airlines Co." OR Description = "American Airlines Inc."
...
--UNCOMMENT_FOR_DEMO   ADD TABLE airlinedata.flights 
--UNCOMMENT_FOR_DEMO   PARTITION (UniqueCarrier = "AA", year LIKE "2008%") as airlinedata.`2008_flights`;
