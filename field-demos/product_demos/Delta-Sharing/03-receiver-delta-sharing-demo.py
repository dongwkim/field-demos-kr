...
table_url = f"{americanairlines_profile}#americanairlines.airlinedata.lookupcodes"
...
spark_flights_df = delta_sharing.load_as_spark("/FileStore/americanairlines.share#americanairlines.airlinedata.2008_flights")
...
spark_flights_df = spark.read.format('deltaSharing').load("/FileStore/americanairlines.share#americanairlines.airlinedata.2008_flights")
