...
# MAGIC 
# MAGIC ## Make sure you initialize your OMOP data before!
# MAGIC 
# MAGIC Open and run the [02-run-all-OMOP-lakehouse]($../02-run-all-OMOP-lakehouse) notebook before running these cells!
# MAGIC 
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&cid=555&aip=1&t=event&ec=field_demos&ea=display&dp=%2F42_field_demos%2Fhls%2Fomop%2Fanalysis%2Fdrug_trend&dt=HLS_OMOP_DRUG_TREND">
...
# MAGIC fig.update_layout(autosize=False, width=700, height=700)
# MAGIC fig.show()
...
# MAGIC %sql SELECT * FROM COPRESCRIBED
...
# MAGIC   select PERSON_ID,c.concept_name as drug_concept_name, DRUG_CONCEPT_ID,DRUG_ERA_START_DATE,DRUG_ERA_END_DATE
# MAGIC     from drug_era join concept c
# MAGIC   where DRUG_CONCEPT_ID=c.concept_id
# MAGIC   """)
# MAGIC 
