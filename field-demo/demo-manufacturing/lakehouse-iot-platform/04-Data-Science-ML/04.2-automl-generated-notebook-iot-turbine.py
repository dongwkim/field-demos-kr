...
run = get_automl_turbine_maintenance_run(force_refresh = False)
...
supported_cols = ["percentiles_sensor_F", "std_sensor_B", "std_sensor_A", "location", "avg_energy", "std_sensor_E", "state", "std_sensor_C", "std_sensor_F", "percentiles_sensor_E", "percentiles_sensor_D", "percentiles_sensor_A", "std_sensor_D", "hourly_timestamp", "turbine_id", "percentiles_sensor_C", "percentiles_sensor_B"]
...
categorical_one_hot_transformers = [("onehot", one_hot_pipeline, ["location", "state", "turbine_id"])]
...
space = {
  "colsample_bytree": 0.4006936208854529,
  "lambda_l1": 0.10323498403494377,
  "lambda_l2": 0.1014488731175419,
  "learning_rate": 3.696899827692183,
  "max_bin": 495,
  "max_depth": 12,
  "min_child_samples": 20,
  "n_estimators": 7,
  "num_leaves": 752,
  "path_smooth": 90.42314299563124,
  "subsample": 0.7963613824559236,
  "random_state": 668269204,
}
