...
spark.table(f'{database}.turbine_hourly_features').withColumn("dbdemos_turbine_maintenance", predict_maintenance(*columns)).display()
...
# MAGIC std_sensor_D, percentiles_sensor_D, std_sensor_E, percentiles_sensor_E, std_sensor_F, percentiles_sensor_F, location, model, state) as prediction FROM turbine_hourly_features
