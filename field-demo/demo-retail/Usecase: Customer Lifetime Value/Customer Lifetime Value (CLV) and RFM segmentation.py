...
# MAGIC 
# MAGIC Autoloader (`cloudFiles`) will create a Delta table `order_bronze` ready to be requested at scale that we will use later to compute customer RFM metrics
...
# MAGIC * The other model estimates the probability the customer will remain engaged through the end of that period given the patterns of engagement drop-off we see in the customer population.  
# MAGIC 
