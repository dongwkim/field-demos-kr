...
-- DBTITLE 1,We'll upgrade our tables to uc_demo_upgraded catalog
USE CATALOG uc_demo_upgraded;
SHOW TABLES;
...
DROP DATABASE IF EXISTS uc_demo_upgraded.database_upgraded_on_uc CASCADE
...
-- MAGIC upgrade_database(database_to_upgrade = 'uc_database_to_upgrade', catalog_destination = "uc_demo_upgraded", database_destination= 'database_upgraded_on_uc', 
...
-- MAGIC   print(f'moving database hive_metastore.{database_name} to UC uc_demo_upgraded.{database_name} ...')
-- MAGIC   #PLEASE DO NOT RUN this in our env as it'll actually move all the database.
-- MAGIC   #migrate_database(database_name, "uc_demo_upgraded") , ...optional: add table owners and permission option here...
-- MAGIC   
...
-- MAGIC %python
-- MAGIC spark.sql(f'DROP DATABASE IF EXISTS uc_demo_upgraded.database_upgraded_on_uc CASCADE')
-- MAGIC dbutils.fs.rm("/demo/uc/upgrade/checkpoint/", True)
...
-- MAGIC db, tables_migrated, errors = upgrade_database_advanced(database_to_upgrade = 'uc_database_to_upgrade', catalog_destination = "uc_demo_upgraded", database_destination = 'database_upgraded_on_uc', 
-- MAGIC                                   continue_on_exception = False, checkpoint_location = "/demo/uc/upgrade/checkpoint/", force_table_optimization = True,
-- MAGIC                                   table_owner_to = 'account users',    table_privilege = 'ALL PRIVILEGES',    table_privilege_principal = 'account users',
-- MAGIC                                   database_owner_to = 'account users', database_privilege = 'ALL PRIVILEGES', database_privilege_principal = 'account users')
...
-- MAGIC upgrade_database_views_advanced(database_to_upgrade = 'uc_database_to_upgrade', catalog_destination = "uc_demo_upgraded", database_destination = 'database_upgraded_on_uc', 
...
-- MAGIC   else:
-- MAGIC     print(f'moving database hive_metastore.{database_name} to UC uc_demo_upgraded.{database_name} ...')
-- MAGIC     return upgrade_database_advanced(database_to_upgrade = database_name, catalog_destination = "uc_demo_upgraded", database_destination = database_name, 
-- MAGIC                                     continue_on_exception = False, checkpoint_location = "/demo/uc/upgrade/checkpoint/", force_table_optimization = True,
-- MAGIC                                     table_owner_to = 'account users',    table_privilege = 'ALL PRIVILEGES',    table_privilege_principal = 'account users',
-- MAGIC                                     database_owner_to = 'account users', database_privilege = 'ALL PRIVILEGES', database_privilege_principal = 'account users')
-- MAGIC 
...
-- MAGIC   if database_name == "uc_database_to_upgrade":
-- MAGIC     print(f'moving views hive_metastore.{database_name} to UC uc_demo_upgraded.{database_name} ...')
-- MAGIC     upgrade_database_views_advanced(database_to_upgrade = database_name, catalog_destination = "uc_demo_upgraded", database_destination = database_name, 
-- MAGIC                                     databases_upgraded = databases_upgraded, continue_on_exception = False, 
-- MAGIC                                     owner_to = 'account users', privilege = 'ALL PRIVILEGES', privilege_principal = 'account users')
-- MAGIC with ThreadPoolExecutor(max_workers=3) as executor:
