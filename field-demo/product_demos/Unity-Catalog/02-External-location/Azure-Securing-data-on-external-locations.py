...
# MAGIC 
# MAGIC <img src="https://github.com/QuentinAmbard/databricks-demo/raw/main/product_demos/uc/external/azure-uc-external-location.png" style="float:right; margin-left:10px" width="800"/>
# MAGIC 
# MAGIC 
...
# MAGIC 
# MAGIC 
# MAGIC 1. First, create a Storage credential. I'll contain the Service Principal required to access your cloud storage
...
# MAGIC 
# MAGIC <img src="https://github.com/QuentinAmbard/databricks-demo/raw/main/product_demos/uc/external/azure-uc-external-location-1.png" style="float:right; margin-left:10px" width="700px"/>
# MAGIC 
...
# MAGIC 1. Fill your credential information: Directory ID, Application ID and Secret of your Service Principal
# MAGIC 
# MAGIC 
# MAGIC <img src="https://github.com/QuentinAmbard/databricks-demo/raw/main/product_demos/uc/external/azure-storage-credential.png" width="400"/>
...
# MAGIC 
# MAGIC <img src="https://github.com/QuentinAmbard/databricks-demo/raw/main/product_demos/uc/external/azure-uc-external-location-2.png" style="float:right; margin-left:10px" width="700px"/>
# MAGIC 
...
# MAGIC 
# MAGIC <img src="https://github.com/QuentinAmbard/databricks-demo/raw/main/product_demos/uc/external/azure-uc-external-location-3.png" style="float:right; margin-left:10px" width="700px"/>
# MAGIC 
...
# MAGIC 
# MAGIC <img src="https://github.com/QuentinAmbard/databricks-demo/raw/main/product_demos/uc/external/uc-external-location-cred2.png" width="400" >
# MAGIC 
