...
ALTER TABLE airlinedata.lookupcodes SET TBLPROPERTIES (delta.enableChangeDataFeed = true)
ALTER SHARE my_share ADD TABLE airlinedata.lookupcodes WITH CHANGE DATA FEED;
...
-- MAGIC 
-- MAGIC `ALTER TABLE airlinedata.lookupcodes SET TBLPROPERTIES (delta.enableChangeDataFeed = true);`
-- MAGIC `ALTER SHARE my_share ADD TABLE airlinedata.lookupcodes WITH CHANGE DATA FEED;`
