...
model = mlflow.pyfunc.spark_udf(spark, model_uri="models:/demos_customer_churn/Staging")
...
#spark.sql(f"""SELECT customer_id, predict_churn(struct(`{"`,`".join(model_features)}`)) as prediction from {dbName}.churn_features""").display()
...
# MAGIC * [Explore DBSQL Churn Dashboard](/sql/dashboards/1e236ef7-cf58-4bfc-b861-5e6a0c105e51-churn-prediction-dashboard---universal?o=1444828305810485#)
